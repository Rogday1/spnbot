...
DEFAULT_PROBABILITIES = {
    0: 70,     # 70% вероятность выпадения 0
    300: 10,   # 10% вероятность выпадения 300
    500: 10,   # 10% вероятность выпадения 500
    1000: 5,   # 5% вероятность выпадения 1000
    2000: 5    # 5% вероятность выпадения 2000
}
